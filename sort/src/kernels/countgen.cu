...
#define SCAN_BLOCK_COUNTS true
#define SINGLE_BLOCK_TASK true
...
GEN_COUNT_LOOP(CountBucketsLoop_1, NUM_THREADS, 1, INNER_LOOP, 1, \
	SCAN_BLOCK_COUNTS, SINGLE_BLOCK_TASK, 8)
...
GEN_COUNT_LOOP(CountBucketsLoop_6, NUM_THREADS, 6, INNER_LOOP, 1, \
	SCAN_BLOCK_COUNTS, SINGLE_BLOCK_TASK,  6)

// 25% occupancy
GEN_COUNT_LOOP(CountBucketsLoop_7, NUM_THREADS, 7, INNER_LOOP, 1, \
	SCAN_BLOCK_COUNTS, SINGLE_BLOCK_TASK,  3)
